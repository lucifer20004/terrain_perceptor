...
class MaskDataset(Dataset):
    def __init__(self, data_dir, transform=None, mask_transform=None):
        ...
        self.image_dir = os.path.join(data_dir, "train", "Color_Images")
        self.mask_dir  = os.path.join(data_dir, "train", "Segmentation_Images")
    ...
    def __getitem__(self, idx):
        ...
        mask_path = os.path.join(self.mask_dir, data_id)
...
def main():
    ...
    val_dir =  "Offroad_Segmentation_Training_Dataset"
